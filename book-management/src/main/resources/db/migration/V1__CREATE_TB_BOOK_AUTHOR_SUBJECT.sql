CREATE TABLE TB_BOOK (
  ...
  BOOK_CODE BIGINT NOT NULL UNIQUE,
...
CREATE INDEX IND_TB_BOOK_AUTHOR_BOOK_CODE ON TB_BOOK_AUTHOR(BOOK_CODE);
CREATE INDEX IND_TB_BOOK_AUTHOR_AUTHOR_CODE ON TB_BOOK_AUTHOR(AUTHOR_CODE);

CREATE INDEX IND_TB_BOOK_SUBJECT_BOOK_CODE ON TB_BOOK_SUBJECT(BOOK_CODE);
CREATE INDEX IND_TB_BOOK_SUBJECT_SUBJECT_CODE ON TB_BOOK_SUBJECT(SUBJECT_CODE);